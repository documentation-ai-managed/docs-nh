...
description: "Hướng dẫn kích hoạt các công cụ tăng tốc bán hàng: Tự động thu hồi Lead, Gọi điện nhanh và AI tóm tắt cuộc gọi."
type: "guide"
---
...
<Columns cols="3">
  <Card title="Thu hồi Lead tự động" icon="clock" href="#thu-hoi-lead-tu-dong-ic-10" horizontal="false">
    Tự động thu hồi Lead về kho chung nếu sau 2 giờ không có tương tác.
  </Card>
  <Card title="Click-to-Call" icon="phone" href="#goi-dien-nhanh-cs-05" horizontal="false">
    Bấm gọi trực tiếp cho khách hàng ngay trên giao diện phần mềm.
  </Card>
  <Card title="Trợ lý AI cuộc gọi" icon="cpu" href="#tro-ly-ai-cuoc-goi-cs-06" horizontal="false">
